...
func _run_scenarios() -> void:
	...
	var alerts: ShieldCriticalAlertController = game.get_node("ShieldCriticalAlertController")
	var presenter: Control = game.get_node("CanvasLayer/ShieldCriticalAlertPresenter")
	var message_label: Label = game.get_node("CanvasLayer/ShieldCriticalAlertPresenter/MessageLabel")
	alerts.critical_alert_raised.connect(_on_critical_alert_raised)
	assert(presenter.get_node_or_null("AudioStreamPlayer") == null)
