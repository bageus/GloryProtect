...
Сценарии Godot для прочности добавлены, но текущий GitHub Actions запускает только проверку размера файлов. Перед слиянием PR их необходимо выполнить локально или подключить к CI.
