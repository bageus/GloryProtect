...
@export_range(0.0, 1000.0, 1.0) var front_sweep_minimum_speed: float = 80.0
...
@export_range(0.05, 5.0, 0.05) var front_sweep_cooldown: float = 0.25
...
@export_range(1.0, 500.0, 1.0) var ground_core_radius: float = 150.0
@export_range(1.0, 500.0, 1.0) var platform_core_radius: float = 180.0
