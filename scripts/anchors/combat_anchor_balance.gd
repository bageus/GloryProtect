...
@export_range(0.1, 20.0, 0.1) var drop_pulse_interval_seconds: float = 2.0
...
@export_range(0.0, 500.0, 1.0) var endpoint_pulse_radius: float = 240.0
@export_range(1, 20, 1) var trap_remove_damage: int = 1
@export_range(0.0, 500.0, 1.0) var trap_remove_radius: float = 240.0
@export_range(0.0, 500.0, 1.0) var trap_knockback_distance: float = 300.0
@export_range(1, 20, 1) var trap_attach_damage: int = 1
@export_range(0.0, 500.0, 1.0) var trap_attach_radius: float = 240.0
...
func is_valid() -> bool:
	return (
		...
		and drop_pulse_interval_seconds > 0.0
