...
@export_range(0.05, 1.0, 0.05) var rope_damaged_ratio: float = 0.5
@export_range(0.0, 0.95, 0.05) var rope_critical_ratio: float = 0.25
@export_range(0.1, 20.0, 0.1) var rope_warning_pulse_speed: float = 5.0
